...
class ChatBot:
    ...
    def main_window(self):
        ...
        self.tab.add(self.bot_frame,text='TheBot'.center(100))
    ...
    def add_bot(self):
        ...
        head_label=Label(self.bot_frame,bg=BG_COLOR,fg=TEXT_COLOR,text="Welcome to TheBot",font=FONT_BOLD,pady=10)
